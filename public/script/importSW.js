...
async function updateCache(){
	...
	// btw on en profite pour afficher la version si un élement a un id "usedVersion"
	if(document.getElementById('usedVersion')) document.getElementById('usedVersion').innerText = version
}
