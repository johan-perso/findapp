...
async function updateCache(){
	await caches.open('findapp-cache').then(cache => {
		return cache.addAll([
			...
			'https://firebasestorage.googleapis.com/v0/b/storage-bf183.appspot.com/o/findapp-screenshots%2Ffindapp-exempleSourceJson.png?alt=media',
			'https://firebasestorage.googleapis.com/v0/b/storage-bf183.appspot.com/o/otherImages%2FAPK_defaultIcon.png?alt=media',
			'/',
			'/help',
			'/source',
			'/style.css',
